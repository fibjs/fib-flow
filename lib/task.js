...
class TaskManager {
     ...
     *                                        Supports: 'sqlite:path', 'mysql://...', 'psql://...', 'memory'
     * @param {string} options.dbType - Type of database to use (sqlite, mysql, psql, memory)
    ...
    constructor(options = {}) {
        ...
        // Memory database uses shorter expiry time to avoid memory buildup
        const defaultExpireTime = (dbConnection === 'memory' || dbType === 'memory')
    ...
    use(taskName, handler) {
        ...
        if (typeof handler === 'function') {
            ...
            taskOptions = {
                ...
                running_count: 0,  // Add runtime counter
                description,
                parameters,
                output
            };
