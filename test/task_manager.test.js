...
describe('TaskManager Initialization', () => {
    ...
    it('should use default options when no options are provided', () => {
        ...
        assert.equal(taskManager.options.task_heartbeat_interval, 5000, 'Default task_heartbeat_interval should be 5000');
        assert.equal(taskManager.options.task_heartbeat_timeout, 30000, 'Default task_heartbeat_timeout should be 30000');
        assert.equal(taskManager.options.worker_heartbeat_interval, 5000, 'Default worker_heartbeat_interval should be 5000');
        assert.equal(taskManager.options.worker_heartbeat_timeout, 30000, 'Default worker_heartbeat_timeout should be 30000');
